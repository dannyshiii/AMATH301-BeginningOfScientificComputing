...
n = 3;
title(['\psi functions=' num2str(n)],'Fontsize',[15]); % title with fontsize = 16
text(4,5,'stuff \phi','Fontsize',[15]);% add text at pt (4,5)
...
subplot(2,1,1); % make 2 rows 1 col of plots, then 'draw' upon the 1st figure
subplot(2,1,2);
subplot(2,2,4);
